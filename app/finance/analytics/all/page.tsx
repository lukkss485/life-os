...
const data = [
  { category: "Renda", value: 45000 },
  { category: "Investimentos", value: 82000 },
  { category: "Reserva", value: 25000 },
  { category: "Gastos", value: 14000 },
]
    ...
    <main className="flex-1 space-y-8 p-8 pt-6 max-w-7xl mx-auto">
      <Card className="border-border shadow-xl bg-muted/20 backdrop-blur-md rounded-3xl overflow-hidden">
        <CardHeader>
          ...
          <CardDescription>Comparativo consolidado de valores absolutos</CardDescription>
        </CardHeader>
        <CardContent>
